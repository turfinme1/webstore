  ...
  async usersReportDefinition(data) {
    ...
    const reportFilters = [
        ...
        },
        {
            ...
            filter_expression: "CASE WHEN $FILTER_VALUE$ = 'true' THEN lo.has_paid_order = TRUE ELSE lo.has_paid_order = FALSE END",
            type: "select",
        ...
        },
        {
            ...
            minimum_filter_expression: "lo.total_price >= $FILTER_VALUE$",
            maximum_filter_expression: "lo.total_price <= $FILTER_VALUE$",
            type: "number",
        ...
        },
        {
            ...
            filter_expression: "",
            minimum_filter_expression: "lo.order_count >= $FILTER_VALUE$",
            maximum_filter_expression: "lo.order_count <= $FILTER_VALUE$",
            type: "number",
            label: "Order Count",
            step: '1',
            min: 0,
        ...
        },
        {
            ...
            filter_expression: "",
            minimum_filter_expression: "al.total_login_count >= $FILTER_VALUE$",
            maximum_filter_expression: "al.total_login_count <= $FILTER_VALUE$",
            type: "number",
            label: "Login Count",
            step: '1',
            min: 0,
    ...
    let sql = `
        ...
        filtered_users AS (
            SELECT
                ...
                lo.has_paid_order AS "has_paid_order",
                ...
                SUM(lo.total_price) AS "order_total_paid_amount",
                SUM(lo.order_count) AS "order_count",
