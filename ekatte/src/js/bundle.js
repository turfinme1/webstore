...
/***/ ((module, exports, __webpack_require__) => {
    ...
    var regionSchema = {
      ...
      errorMessage: {
        properties: {
          region_code: "Region code must be at least 3 characters long and contain only Latin letters and digits.",
          name_en: "Name (EN) must be at least 3 characters long and contain only Latin letters and spaces.",
    ...
    var municipalitySchema = {
      ...
      errorMessage: {
        properties: {
          municipality_code: "Municipality code must be at least 5 characters long and contain only Latin letters and digits.",
          name_en: "Name (EN) must be at least 3 characters long and contain only Latin letters and spaces.",
          name: "Name must be at least 3 characters long and contain only Cyrillic letters and spaces.",
    ...
    var validateRegion = ajv.compile(regionSchema);
    var validateMunicipality = ajv.compile(municipalitySchema);
    ...
    var updateErrorMessage = document.getElementById("update-error-message");
    ...
    function fetchRegions() {
      return _fetchRegions.apply(this, arguments);
    } // fetching municipalities
    function _fetchRegions() {
      _fetchRegions = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4() {
        var regions;
            ...
            case 3:
              ...
              if (!regions.errors) {
                ...
                regions.forEach(function (region) {
                  return regionMap.set(region.id, region.name);
                });
              } else {
    ...
    function _fetchMunicipalities() {
      _fetchMunicipalities = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5() {
        var municipalities;
        return _regeneratorRuntime().wrap(function _callee5$(_context5) {
          while (1) switch (_context5.prev = _context5.next) {
            case 0:
              _context5.prev = 0;
              _context5.next = 3;
              return fetchData("/municipalities");
            case 3:
              municipalities = _context5.sent;
            ...
            case 7:
              ...
              errorMessage.textContent = "An error occurred while fetching municipalities.";
            case 11:
            case "end":
    ...
    createForm.addEventListener("submit", /*#__PURE__*/function () {
      var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(e) {
        var formData, validationError, data;
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            case 0:
              e.preventDefault();
              formData = getFormData("create");
              validationError = validateMunicipality(formData) ? null : ajv.errorsText(validateMunicipality.errors);
              if (!validationError) {
                _context2.next = 6;
                break;
              }
            ...
            case 6:
              _context2.prev = 6;
              _context2.next = 9;
              return fetchData("/municipalities", "POST", formData);
            case 9:
              data = _context2.sent;
              if (data.errors) {
    ...
    function getFormData(formType) {
      if (formType === "create") {
        ...
        return {
          municipality_code: document.getElementById("update-municipality-code").value,
    ...
    function generateTable(data) {
      ...
      var columnNames = ["municipality_code", "name_en", "name", "region_name", "actions"];
    ...
    function generateTableHead(table, columnNames) {
      ...
      columnNames.forEach(function (name) {
        ...
        var text = document.createTextNode(name.replaceAll("_", " "));
        th.appendChild(text);
        row.appendChild(th);
      });
    }
    ...
    function generateTableBody(table, data) {
      ...
      data.forEach(function (municipality) {
        var row = createTableRow(municipality, showUpdateForm, deleteHandler);
    ...
    function addTableRow(data) {
      ...
      var row = createTableRow(data, showUpdateForm, deleteHandler);
      tbody.insertBefore(row, tbody.firstChild);
    }
    
    // delete handler
    function deleteHandler(_x2) {
      return _deleteHandler.apply(this, arguments);
    } // update handler
    function _deleteHandler() {
      _deleteHandler = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee6(data) {
        var userConfirmed, response, row;
        return _regeneratorRuntime().wrap(function _callee6$(_context6) {
          while (1) switch (_context6.prev = _context6.next) {
            case 0:
              userConfirmed = window.confirm("Are you sure you want to delete ".concat(data.name, "?"));
              if (!userConfirmed) {
                _context6.next = 13;
                break;
              }
              _context6.prev = 2;
              _context6.next = 5;
              return fetchData("/municipalities?id=".concat(data.id), "DELETE");
            case 5:
              response = _context6.sent;
              if (response.errors) {
                errorMessage.textContent = response.errors;
              } else {
                row = document.querySelector("tr[data-id='".concat(data.id, "']"));
                if (row) {
                  row.remove();
                }
              }
    ...
    function updateHandler(_x3) {
      return _updateHandler.apply(this, arguments);
    } // update table row
    function _updateHandler() {
      _updateHandler = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee7(e) {
        var formData, validationError, response, row;
        return _regeneratorRuntime().wrap(function _callee7$(_context7) {
          while (1) switch (_context7.prev = _context7.next) {
            case 0:
              e.preventDefault();
              formData = getFormData("update");
              validationError = validateMunicipality(formData) ? null : ajv.errorsText(validateMunicipality.errors);
              if (!validationError) {
                _context7.next = 6;
                break;
            ...
            case 6:
              _context7.prev = 6;
              _context7.next = 9;
              return fetchData("/municipalities?id=".concat(updateContainer.dataset.id), "PUT", _objectSpread({}, formData));
            case 9:
              response = _context7.sent;
              if (response.errors) {
                updateErrorMessage.textContent = response.errors;
              } else {
                row = document.querySelector("tr[data-id='".concat(updateContainer.dataset.id, "']"));
    ...
    function showUpdateForm(data) {
      ...
      document.getElementById("update-municipality-code").value = data.municipality_code;
    ...
    document.getElementById("update-cancel").addEventListener("click", hideUpdateForm);
      ...
      _fetchData = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee8(url) {
        ...
        return _regeneratorRuntime().wrap(function _callee8$(_context8) {
          while (1) switch (_context8.prev = _context8.next) {
            case 0:
              method = _args8.length > 1 && _args8[1] !== undefined ? _args8[1] : "GET";
