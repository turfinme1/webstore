...
/***/ "./src/schemas/municipalityEntitySchema.js":
/*!*************************************************!*\
  !*** ./src/schemas/municipalityEntitySchema.js ***!
  \*************************************************/
...
/* harmony export */   municipalitySchema: () => (/* binding */ municipalitySchema)
/* harmony export */ });
var municipalitySchema = {
  type: "object",
  name: "municipality",
...
/***/ "./src/schemas/regionEntitySchema.js":
/*!*******************************************!*\
  !*** ./src/schemas/regionEntitySchema.js ***!
  \*******************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   regionSchema: () => (/* binding */ regionSchema)
/* harmony export */ });
var regionSchema = {
  type: "object",
  name: "region",
...
/***/ "./src/schemas/settlementEntitySchema.js":
/*!***********************************************!*\
  !*** ./src/schemas/settlementEntitySchema.js ***!
  \***********************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   settlementSchema: () => (/* binding */ settlementSchema)
/* harmony export */ });
...
/***/ "./src/schemas/townHallEntitySchema.js":
/*!*********************************************!*\
  !*** ./src/schemas/townHallEntitySchema.js ***!
  \*********************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   townHallSchema: () => (/* binding */ townHallSchema)
/* harmony export */ });
var townHallSchema = {
  type: "object",
  name: "town_hall",
...
/* harmony import */ var ajv_errors__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ajv-errors */ "./node_modules/ajv-errors/dist/index.js");
/* harmony import */ var _schemas_municipalityEntitySchema_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./schemas/municipalityEntitySchema.js */ "./src/schemas/municipalityEntitySchema.js");
/* harmony import */ var _schemas_regionEntitySchema_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./schemas/regionEntitySchema.js */ "./src/schemas/regionEntitySchema.js");
/* harmony import */ var _schemas_townHallEntitySchema_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./schemas/townHallEntitySchema.js */ "./src/schemas/townHallEntitySchema.js");
/* harmony import */ var _schemas_settlementEntitySchema_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./schemas/settlementEntitySchema.js */ "./src/schemas/settlementEntitySchema.js");
...
var schemas = {
  "crud-regions": _schemas_regionEntitySchema_js__WEBPACK_IMPORTED_MODULE_4__.regionSchema,
  "crud-municipalities": _schemas_municipalityEntitySchema_js__WEBPACK_IMPORTED_MODULE_3__.municipalitySchema,
  "crud-town-halls": _schemas_townHallEntitySchema_js__WEBPACK_IMPORTED_MODULE_5__.townHallSchema,
  "crud-settlements": _schemas_settlementEntitySchema_js__WEBPACK_IMPORTED_MODULE_6__.settlementSchema
};
...
function attachValidationListeners(formId, schema) {
  ...
  form.addEventListener("submit", function (event) {
    ...
    var id = data.id,
      dataWithoutId = _objectWithoutProperties(data, _excluded);
    // Clear previous error messages
    document.querySelectorAll(".field-error-message").forEach(function (el) {
      return el.innerText = "";
    });
    document.querySelector(".generic-error-message").innerText = "";
    var valid = validate(dataWithoutId);
    if (!valid) {
      // Display errors
      validate.errors.forEach(function (error) {
        var field = error.instancePath.slice(1); // remove the leading slash
        var errorMessageEl = document.getElementById("".concat(field, "-error"));
        if (errorMessageEl) {
          errorMessageEl.innerText = error.message;
        }
      });
      console.log("Form data is invalid", validate.errors);
      document.querySelector(".generic-error-message").innerText = "Please fix the errors above.";
    } else {
      console.log("Form data is valid", data);
      var schemaBasedUrl = "/".concat(schema.routeName);
      var method = formId.includes("update") ? "PUT" : "POST";
      var entityId = formId.includes("update") ? id : null;
...
document.addEventListener("formCreated", function () {
...
document.addEventListener("searchFormCreated", function () {
  var schema = getSchemaBasedOnUrl();
  if (schema) {
...
function handleFormSubmission(_x, _x2, _x3, _x4, _x5) {
  return _handleFormSubmission.apply(this, arguments);
}
function _handleFormSubmission() {
  _handleFormSubmission = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5(url, method, data, formId, entityId) {
    ...
    return _regeneratorRuntime().wrap(function _callee5$(_context5) {
      while (1) switch (_context5.prev = _context5.next) {
        ...
        case 13:
          ...
          console.error("Submission error:", _context5.t0);
...
function createForm(schema, formId) {
  ...
  var _loop = function _loop() {
    ...
    if (key.endsWith("_id")) {
      ...
      // input.name = key;
      input.placeholder = "Search for ".concat(field.label);
      ...
      searchButton.addEventListener("click", /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
        var searchValue, resource, results;
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              searchValue = input.value;
              resource = field.routeName; // Assuming the routeName is the resource to search
              _context.next = 4;
              return fetchSearchResults(resource, searchValue);
            case 4:
...
function fetchSearchResults(_x6, _x7) {
  return _fetchSearchResults.apply(this, arguments);
}
function _fetchSearchResults() {
  _fetchSearchResults = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee6(key, query) {
    var pageSize,
      response,
      data,
      _args6 = arguments;
    return _regeneratorRuntime().wrap(function _callee6$(_context6) {
      while (1) switch (_context6.prev = _context6.next) {
        case 0:
          pageSize = _args6.length > 2 && _args6[2] !== undefined ? _args6[2] : 100;
          _context6.next = 3;
          return fetch("/".concat(key, "?searchParam=").concat(encodeURIComponent(query), "&pageSize=").concat(pageSize));
        case 3:
        ...
        case 7:
          data = _context6.sent;
          return _context6.abrupt("return", data.rows);
        case 9:
...
function fetchReferentialEntity(_x8, _x9) {
  return _fetchReferentialEntity.apply(this, arguments);
}
function _fetchReferentialEntity() {
  _fetchReferentialEntity = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee7(key, id) {
    var response, data;
    return _regeneratorRuntime().wrap(function _callee7$(_context7) {
      while (1) switch (_context7.prev = _context7.next) {
        case 0:
          _context7.next = 2;
          return fetch("/".concat(key, "?id=").concat(id));
        case 2:
...
function createTable(schema, data, totalRowCount, searchParam, searchColumn, orderColumn, orderType, page, pageSize) {
  ...
  data.forEach(function (item) {
    ...
    editButton.addEventListener("click", /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3() {
      return _regeneratorRuntime().wrap(function _callee3$(_context3) {
        while (1) switch (_context3.prev = _context3.next) {
          case 0:
            return _context3.abrupt("return", handleEdit(schema, item));
          case 1:
          case "end":
    ...
    deleteButton.addEventListener("click", /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4() {
      return _regeneratorRuntime().wrap(function _callee4$(_context4) {
        while (1) switch (_context4.prev = _context4.next) {
          case 0:
            return _context4.abrupt("return", handleDelete(schema, item));
          case 1:
          case "end":
...
function renderTable(_x11) {
  return _renderTable.apply(this, arguments);
}
function _renderTable() {
  _renderTable = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee8(schema) {
    var searchParam,
      searchColumn,
      orderColumn,
      orderType,
    ...
    return _regeneratorRuntime().wrap(function _callee8$(_context8) {
      while (1) switch (_context8.prev = _context8.next) {
        case 0:
          searchParam = _args8.length > 1 && _args8[1] !== undefined ? _args8[1] : "";
          searchColumn = _args8.length > 2 && _args8[2] !== undefined ? _args8[2] : "all";
          orderColumn = _args8.length > 3 && _args8[3] !== undefined ? _args8[3] : "id";
          orderType = _args8.length > 4 && _args8[4] !== undefined ? _args8[4] : "ASC";
          page = _args8.length > 5 && _args8[5] !== undefined ? _args8[5] : 1;
          pageSize = _args8.length > 6 && _args8[6] !== undefined ? _args8[6] : 10;
          _context8.prev = 6;
        ...
        case 22:
          ...
          console.error("Error fetching ".concat(schema.name, " data:"), _context8.t0);
        case 25:
        case "end":
...
function handleEdit(_x12, _x13) {
  return _handleEdit.apply(this, arguments);
}
function _handleEdit() {
  _handleEdit = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee9(schema, item) {
    var response, data, formContainer, updateFormElement, key, input, select, relatedData, option, event;
    return _regeneratorRuntime().wrap(function _callee9$(_context9) {
      while (1) switch (_context9.prev = _context9.next) {
        ...
        case 16:
          ...
          select = document.getElementById("".concat(key, "_select"));
          if (!select) {
            _context9.next = 32;
            break;
          }
          _context9.next = 24;
          return fetchReferentialEntity(schema.properties[key].routeName, data[key]);
        case 24:
          relatedData = _context9.sent;
          select.innerHTML = "";
...
function handleDelete(_x14, _x15) {
  return _handleDelete.apply(this, arguments);
}
function _handleDelete() {
  _handleDelete = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee10(schema, item) {
    var response, data;
